...
namespace IPLab
{
	...
	public class MainForm : System.Windows.Forms.Form, IDocumentsHost
	{
		...
		private void InitializeComponent()
		{
            ...
            // pageSetupFileItem
            // 
            this.pageSetupFileItem.Index = 11;
            this.pageSetupFileItem.Text = "Sayfa Düzeni";
            this.pageSetupFileItem.Click += new System.EventHandler(this.pageSetupFileItem_Click);
            // 
            // printFileItem
            // 
            this.printFileItem.Index = 12;
            this.printFileItem.Text = "Yazdýr";
            this.printFileItem.Click += new System.EventHandler(this.printFileItem_Click);
            // 
            // printPreviewFileItem
            // 
            this.printPreviewFileItem.Index = 13;
            this.printPreviewFileItem.Text = "Önizleme";
            ...
            // exitFileItem
            // 
            this.exitFileItem.Index = 15;
            this.exitFileItem.Text = "Çýkýþ";
            ...
            this.histogramViewItem.Visible = false;
            ...
            this.statisticsViewItem.Text = "Kir Ýstatistiði";
            ...
            this.centerViewItem.Text = "Resmi Ortala";
            ...
            this.windowItem.Text = "Pencereler";
            // 
            // helpItem
            // 
            ...
            this.helpItem.Text = "Yardým";
            // 
            // aboutHelpItem
            // 
            this.aboutHelpItem.Index = 0;
            this.aboutHelpItem.Text = "Hakkýnda";
            ...
            this.mainToolBar.Location = new System.Drawing.Point(456, 72);
            ...
            this.openButton.ToolTipText = "Dosya aç";
            // 
            // saveButton
            // 
            this.saveButton.ImageIndex = 1;
            this.saveButton.Name = "saveButton";
            this.saveButton.ToolTipText = "Kaydet";
            // 
            // sep1
            // 
            this.sep1.Name = "sep1";
            ...
            this.copyButton.ToolTipText = "Panoya Kopyala";
            // 
            // pasteButton
            // 
            this.pasteButton.ImageIndex = 3;
            this.pasteButton.Name = "pasteButton";
            this.pasteButton.ToolTipText = "Panodan Yapýþtýr";
            // 
            // toolBarButton9
            // 
            ...
            this.aboutButton.ToolTipText = "Hakkýnda...";
            // 
            // imageList
            // 
            ...
            this.imageToolBar.Location = new System.Drawing.Point(152, 313);
            ...
            this.cloneButton.ToolTipText = "Çoðalt";
            // 
            // toolBarButton1
            // 
            ...
            this.cropButton.ToolTipText = "Kýrp";
            // 
            // toolBarButton2
            // 
            ...
            this.toolBarButton3.ToolTipText = "Orijinal Boyut";
            // 
            // fitToScreenButton
            // 
            this.fitToScreenButton.ImageIndex = 5;
            this.fitToScreenButton.Name = "fitToScreenButton";
            this.fitToScreenButton.ToolTipText = "Pencereye Sýðdýr";
            // 
            // toolBarButton5
            // 
            ...
            this.resizeButton.ToolTipText = "Yeniden Boyutlandýr";
            // 
            // rotateButton
            // 
            this.rotateButton.ImageIndex = 12;
            this.rotateButton.Name = "rotateButton";
            this.rotateButton.ToolTipText = "Döndür";
            // 
            // toolBarButton7
            // 
            ...
            this.thresholdButton.ToolTipText = "Analizi Baþlat";
            // 
            // toolBarButton6
            // 
            ...
            this.menuItem4.Text = "Tarayýcýdan Görüntü Al";
            ...
            this.Text = "Bulaþýk Makinasý - Kir Ölçüm Yazýlýmý (murat.kantas@arcelik.com)";
        ...
        private void buttonScan_Click_1(object sender, EventArgs e)
        {
            ...
            if (scannerDevice != null)
            {
                ...
                //AdjustScannerSettings(scannnerItem, 400, 10, 10, 1560, 1850, 0, 0);
                AdjustScannerSettings(scannnerItem, 600, 10, 10, 2340, 2780, 0, 0);
                object scanResult = commonDialogClass.ShowTransfer(scannnerItem, WIA.FormatID.wiaFormatPNG, false);
                if (scanResult != null)
                {
                    ImageFile image = (ImageFile)scanResult;
                    string fileName = DateTime.Now.ToString("yyyy_MM_dd_hh-mm-ss") + ".jpg";
                   ...
                   // pictureBoxScannedImage.SizeMode = PictureBoxSizeMode.StretchImage;
                    //textBox1.Text = Convert.ToString(fileName);
                    ofd.FileName = Convert.ToString(fileName);
                    ImageDoc imgDoc = null;
                    imgDoc = new ImageDoc(ofd.FileName, (IDocumentsHost)this);
                    imgDoc.Text = Path.GetFileName(ofd.FileName);
                    imgDoc.Show(dockManager);
        ...
        private void menuItem4_Click(object sender, EventArgs e)
        {
            ...
            if (scannerDevice != null)
            {
                ...
                {
                    ImageFile image = (ImageFile)scanResult;
                    string fileName = "MK_" + DateTime.Now.ToString("yyyy_MM_dd_hh-mm-ss") + ".jpg";
